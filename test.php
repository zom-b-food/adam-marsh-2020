...
<head>
    ...
    <title>www.irisandpith.com - resources</title>
    <?php include "../sitewide/globals-w.php"; ?>
...
<header class="splash">
    ...
    <section id="am-fixed">
        <div class="header">
            ...
            <table class="rufus">
                <tr>
                    <td style="width:20%;"><a href="#0"><img id="am-logo" src="/assets/images/scrollNav/nametag.png" alt="Nametag"></a></td>
                    ...
                    <td class="uk-hidden-small" style="width:20%;"> <a href="#0"><img id="am-nametag" src="/assets/images/scrollNav/logo.png" alt="Logo"></a></td></tr>
            </table>
        </div>
