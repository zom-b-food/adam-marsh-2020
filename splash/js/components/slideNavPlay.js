$(function () {
    ...
    $(window).on('scroll', function () {
        ...
        ( $(window).scrollTop() > taglineOffesetTop ) ? $('#am-logo, #am-nametag').addClass('is-hidden') : $('#am-logo, #am-nametag').removeClass('is-hidden');
        ...
        if ($(window).scrollTop() > fixedNavTopPosition) {
            ...
            setTimeout(function () {
                ...
                $('#am-nametag').removeClass('slide-in');
