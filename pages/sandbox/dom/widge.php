...
<head>
	...
	<link type="text/css" rel="stylesheet" href="./sandbox/dom/jquery-ui.css"/>

	<script type="text/javascript" src="./sandbox/dom/jquery-1.11.1.min.js"></script>



	<script type="text/javascript" src="./sandbox/dom/jquery-ui-1.10.3.js"></script>





	<script src="./sandbox/dom/jquery-1.8.3.min.js" type="text/javascript"></script>



	<link type="text/css" rel="stylesheet" href="./sandbox/dom/widget.css"/>
			...
			$("#btnUpdate").live("click", function () {
				...
				$('#select2 option').map(function () {
					...
					return $('<a/>', {class: $(this).val() + ' ' + '', id: 'enableProfiles' + $(this).val(),
						...
						href: './includes/profile' + $(this).text() + '.php', text: $(this).text()}).get(); // or this.value / $(this).val()
...
<div id="container-page">
		...
		<p>Dynamic widget that builds a URL based on user input from two select fields and then writes an array of
